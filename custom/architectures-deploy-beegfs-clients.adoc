...
NOTE: No almacene contraseñas en texto sin formato. En su lugar, utilice Ansible Vault (consulte link:https://docs.ansible.com/ansible/latest/user_guide/vault.html["Documentación de Ansible"^] Para cifrar contenido con Ansible Vault) o usar el `--ask-become-pass` al ejecutar el libro de estrategia.
...
Para obtener una lista completa de los parámetros compatibles y más detalles consulta link:https://github.com/NetApp/beegfs/tree/master/roles/beegfs_client["Documentación completa del cliente de BeeGFS"^]. Para ver un ejemplo completo de un inventario de clientes haz clic en link:https://github.com/NetApp/beegfs/blob/master/getting_started/beegfs_on_netapp/gen2/H2_DAC_IB_A2_EF600/beegfs_client/beegfs_client_inventory.yml["aquí"^].
...
Para ver un ejemplo completo de un manual de estrategias para clientes, haz clic en link:https://github.com/NetApp/beegfs/blob/master/getting_started/beegfs_on_netapp/gen2/H2_DAC_IB_A2_EF600/beegfs_client/beegfs_client_playbook.yml["aquí"^].
