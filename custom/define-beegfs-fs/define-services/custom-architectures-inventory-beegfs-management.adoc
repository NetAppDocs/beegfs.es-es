...
Cree un archivo nuevo `group_vars/mgmt.yml` y haciendo referencia a la link:custom-architectures-plan-file-system.html["Planifique el sistema de archivos"^] sección rellenarla de la siguiente forma:
