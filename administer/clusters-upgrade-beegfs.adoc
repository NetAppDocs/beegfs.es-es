...
NOTE: Si estás actualizando a BeeGFS v8, consulta el procedimiento link:clusters-upgrade-beegfs-v8.html["Actualiza a BeeGFS v8"] en su lugar.
...
| 7.4.6 | 8,0 | Sí | Actualiza usando las instrucciones en el procedimiento link:clusters-upgrade-beegfs-v8.html["Actualiza a BeeGFS v8"]. 


| 7.4.6 | 8,1 | Sí | Actualiza usando las instrucciones en el procedimiento link:clusters-upgrade-beegfs-v8.html["Actualiza a BeeGFS v8"]. 


| 7.4.6 | 8,2 | Sí | Actualiza usando las instrucciones en el procedimiento link:clusters-upgrade-beegfs-v8.html["Actualiza a BeeGFS v8"]. 
|===
